// week11.cpp : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
//
...
//int main()
//{
//	Mat srcMat = imread("C:\\Users\\27318\\Desktop\\大二下网络课程\\数字图像\\第十一周\\");
//	
...
int mouseROI()
{
	cv::Mat srcMat = imread("C:\\picture\\3.jpg");
	cv::Mat dstMat;
...
int dftDemo() {
	...
	cv::Mat srcMat = imread("C:\\picture\\3.jpg", 0);
...
{
	cv::Mat dst;
	cv::Mat src = imread("C:\\picture\\3.jpg", 0);
